...
MainWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    return SingleTriangle::GetApp()->MsgProc(hwnd, msg, wParam, lParam);
}

SingleTriangle* SingleTriangle::mApp = nullptr;
SingleTriangle* SingleTriangle::GetApp()
{
    return mApp;
}

SingleTriangle::SingleTriangle(HINSTANCE hInstance)
    : mhAppInst(hInstance)
{
...
LRESULT SingleTriangle::MsgProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    switch (message)
    {
    case WM_CREATE:
...
bool SingleTriangle::InitMainWindow()
{
    ...
    windowClass.lpszClassName = L"LearnSingleTriangleAbstract";
    ...
    mhMainWnd = CreateWindow(
        ...
        L"03.LearnSingleTriangleAbstract",
        WS_OVERLAPPEDWINDOW,
        CW_USEDEFAULT,
        CW_USEDEFAULT,
...
void SingleTriangle::LoadPipeLine()
{
...
void SingleTriangle::CreateDXGI()
{
...
void SingleTriangle::CreateFence()
{
    m_device->CreateFence(0, D3D12_FENCE_FLAG_NONE, IID_PPV_ARGS(&m_fence));
    m_fenceValue = 1;
}

void SingleTriangle::CreateCommandObjects()
{
...
void SingleTriangle::CreateSwapChain()
{
...
void SingleTriangle::CreateDescriptorHeaps()
{
...
void SingleTriangle::LoadAssets()
{
...
void SingleTriangle::BuildRootSignature()
{
...
void SingleTriangle::BuildShadersAndInputLayout()
{
...
void SingleTriangle::BuildGeometry()
{
...
void SingleTriangle::ResetCommandList()
{
...
void SingleTriangle::SetCommandList()
{
    // Set necessary state.
...
void SingleTriangle::DrawCommandList()
{
    // Record commands.
...
void SingleTriangle::ExecuteCommandList()
{
...
void SingleTriangle::WaitForPreviousFrame()
{
