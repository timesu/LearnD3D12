...
class TexturedBoxRolling
{
public:
	TexturedBoxRolling(HINSTANCE hInstance);

public:
	static TexturedBoxRolling* GetApp();
...
protected:
	...
	static TexturedBoxRolling* mApp;
	...
	XMFLOAT4 cameraPosition = XMFLOAT4(-1.0f, 4.0f, -3.0f, 0.0f);
